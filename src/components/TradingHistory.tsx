      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-dark-light rounded-xl p-6 border border-gold/20 shadow-lg">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Left side - Chart and main stats */}
            <div>
            ...
            {/* Right side - Live signal */}
            <div className="flex flex-col h-full">
              <Card className="bg-dark border border-gold/20 mb-6">
                <CardHeader className="pb-0">
                  <CardTitle className="text-2xl text-center font-bold text-red-500">Live signal</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-2 gap-6 mt-6">
                    <div className="text-center">
                      <span className="text-4xl font-bold text-green-500">5</span>
                      <p className="text-gray-400">weeks (since 2021)</p>
                    </div>
                    <div className="text-center">
                      <span className="text-4xl font-bold text-gray-300">0</span>
                      <p className="text-gray-400">0 USD</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              
              <Card className="bg-dark border border-gold/20 flex-grow">
                <CardHeader>
